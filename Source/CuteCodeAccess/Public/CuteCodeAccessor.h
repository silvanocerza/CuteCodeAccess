...
#include "Developer/SourceCodeAccess/Public/ISourceCodeAccessor.h"

class FCuteCodeAccessor : public ISourceCodeAccessor
{
public:
	FCuteCodeAccessor()
	{
...
private:
	...
	/** Wrapper for Qt Creator executable launch information */
	struct FLocation
	{
		bool IsValid() const
		{
	...
	/** Critical section for updating CachedSolutionPath */
	...
	/** Helper function for launching the Qt Creator instance with the given list of arguments */
